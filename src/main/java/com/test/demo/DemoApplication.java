...
import com.test.demo.scheduler.NumberGeneratorJob;
...
//        context.close();
   ...
   /* @MessagingGateway(defaultRequestChannel = "toTcp.input")
    ...
    public TcpNetServerConnectionFactory connectionFactory() {
        return new TcpNetServerConnectionFactory(2222);
    }

    @Bean
    public TcpReceivingChannelAdapter server(TcpNetServerConnectionFactory connectionFactory) {
...
//
//        private final static int MAX_CACHED = 40; // When this is exceeded, we remove the LRU.
//
